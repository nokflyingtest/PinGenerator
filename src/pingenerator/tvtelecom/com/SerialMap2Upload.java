...
@WebServlet("/SerialMap2Upload")
@MultipartConfig
public class SerialMap2Upload extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public SerialMap2Upload() {
        super();
    }

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        Logger LOG = Logger.getLogger(SerialMap2Upload.class.getName());
...
LOG.log(Level.INFO,"SerialMap2Upload uploadFolder:{0} uploadFileName:{1}",new Object[]{uploadFolder,fileNameUploaded});	
		
		Connection con = null;
		Statement st = null;
		ResultSet rs = null;
		String sql = "insert into job (JOBID,TYPE,STATUS,DESC1,UPDATEDBY,UPDATEDDATE) values ('" + jobId + "','SM','I','" + fileNameUploaded + "',"+ userId + ",CURRENT_TIMESTAMP)";
